...
// UsesNetworkResourceInDifferentTenant determines whether the AzureAuthConfig indicates to use network resources in different AAD Tenant than those for the cluster
// Return true when NetworkResourceTenantID is defined and NetworkResourceTenantID is not equal to default tenant ID.
...
// UsesNetworkResourceInDifferentSubscription determines whether the AzureAuthConfig indicates to use network resources in different subscription than those for the cluster
// Return true when NetworkResourceSubscriptionID is defined and NetworkResourceSubscriptionID is not equal to default subscription ID.
